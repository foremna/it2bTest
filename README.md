...
## :pencil: Именование веток
* именуйте ветку по принципу ветка/IT2B-что-я-правлю, например, feature/IT2B-header.
* ветка feature/IT2B-administration используется для служебных правок. Правки в данной ветке вносит только Teamlead
